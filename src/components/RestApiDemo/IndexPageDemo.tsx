...
type Country = keyof typeof COLORS;

function IndexPageDemo({ countries }: { countries: Country[] }) {
	return (
		<>
...
function Flag({ country, index }: { country: Country; index: number }) {
	if (country === 'germany') {
		return (
			<HorizontalColorFlag
