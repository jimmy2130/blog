...
function SecondDemo() {
	const browserBackRef = React.useRef<HTMLButtonElement>(null);
	const browserForwardRef = React.useRef<HTMLButtonElement>(null);
	const titleRef = React.useRef<HTMLButtonElement>(null);
	const websiteBackRef = React.useRef<HTMLButtonElement>(null);
	...
	function handleBrowserBackClick(
	...
	function handleBrowserForwardClick(
		event: React.PointerEvent<HTMLButtonElement>,
	) {
		event.preventDefault();
	...
	function handleTitleClick(event: React.PointerEvent<HTMLButtonElement>) {
		event.preventDefault();
	...
	function handleWebsiteBackClick(
		event: React.PointerEvent<HTMLButtonElement>,
	) {
		event.preventDefault();
		const nextUrls = [
