...
function DetailPageDemo({ country = 'bel', interaction, width }: Props) {
...
function DetailPageText({ width }: { width: number }) {
	let leftSideX = 0;
	if (width >= 648) {
		leftSideX = width - 304;
	} else if (width >= 592) {
...
function DetailBelgium({ width }: { width: number }) {
	return (
...
function DetailFrance({ width }: { width: number }) {
	return (
		<Wrapper style={{ '--flag-scale': getScale(width) }}>
			<path
				d="M32 234C32 229.582 35.5817 226 40 226H118.667V402H40C35.5817 402 32 398.418 32 394V234Z"
...
function DetailGermany({ width }: { width: number }) {
	return (
		<Wrapper style={{ '--flag-scale': getScale(width) }}>
			<path
...
function DetailGuinea({ width }: { width: number }) {
	return (
		<Wrapper style={{ '--flag-scale': getScale(width) }}>
			<path
				d="M32 234C32 229.582 35.5817 226 40 226H118.667V402H40C35.5817 402 32 398.418 32 394V234Z"
...
function isValidCountry(
	country: string,
): country is keyof typeof COUNTRIES_COMPONENT {
	const validCountries = Object.entries(COUNTRIES_COMPONENT).map(
		([key]) => key,
	);
