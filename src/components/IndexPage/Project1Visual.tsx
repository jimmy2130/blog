...
function moveAnimation(on: boolean) {
	return {
		'--translate': on
...
function backgroundUnderImageAnimation(on: boolean) {
	return {
...
function textUnderImageAnimation(on: boolean) {
	return {
...
function detailTextAnimation(order: number, on: boolean) {
	return {
