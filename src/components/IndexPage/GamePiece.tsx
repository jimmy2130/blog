...
type Props = {
	...
	id: number;
	focusableId: number;
	moveFocusPosition: (key: string) => void;
	openedCircleNum: number;
	increaseOpenedCircleNum: () => void;
};
...
function useFocus(id: number, focusableId: number) {
