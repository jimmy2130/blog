...
function ThirdDemo() {
	...
	function handleStartPause(event: React.PointerEvent<HTMLButtonElement>) {
	...
	function handleExpandCollapse(event: React.PointerEvent<HTMLButtonElement>) {
		event.preventDefault();
		setIsExpanded(!isExpanded);
	}

	function handleToggle(event: React.PointerEvent<HTMLButtonElement>) {
		event.preventDefault();
	...
	return (
		<Wrapper>
			<ThirdDemoBoard time={time} isExpanded={isExpanded} mode={mode} />
			<ButtonGroup>
