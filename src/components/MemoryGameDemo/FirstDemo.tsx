...
import { type FirstDemoPiece } from './types';

const INITIAL_GAME: FirstDemoPiece[] = [
	{ state: 'cover', id: 'abc' },
	{ state: 'cover', id: 'def' },
];

// 從mdx指定要成功的Demo還是失敗的Demo
function FirstDemo({ match = 'fail' }: { match?: 'fail' | 'success' }) {
	...
	function reveal(id: string) {
		...
		const nextGame = [...game];
		const nextPiece: FirstDemoPiece = { ...piece, state: 'active' };
