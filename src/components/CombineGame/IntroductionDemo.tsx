...
type Props = {
	questions: { question: string[]; correctAnswer: unknown }[];
	children: React.ReactNode[];
};

function IntroductionDemo({ questions, children }: Props) {
	const [gameStatus, setGameStatus] = React.useState('preparing');
	const [guesses, setGuesses] = React.useState<(null | boolean)[]>(
	...
	function handleRespond(guess: boolean) {
